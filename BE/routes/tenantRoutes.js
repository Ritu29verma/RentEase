...
const { getTenantById, verifyTokenAndSetPassword, login, getMyProperty,updateTenantProfile, dashboardStats, getTotalTenants } = require("../controllers/tenantController");
